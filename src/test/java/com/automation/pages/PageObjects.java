...
import static com.automation.utilities.Utility.waitUntilVisibilityOfElementLocated;
...
public class PageObjects extends BasePage {
    ...
    public void selectAudioPreferences(String on_off){
        ...
        waitForStaleElement(buttonAudioOn);
        //waitForVisibility(buttonAudioOn, 3);
    ...
    public String isPercentageFullyLoaded(){
        waitForPageToLoad(3);
        waitForVisibility(loadPercentage, 3);
    ...
    public Boolean isHomePage() {
        waitUntilVisibilityOfElementLocated(locatorButtonBegin, 20);
    ...
    public void clickRightArrow(){
        waitForPageToLoad(3);
        waitArrowToBeUnlocked(btnRightArrow,5);
        btnRightArrow.click();
    }
    ...
    public Boolean isArrowUnlocked(){
        waitVideoToBeStarted(byElapsedTime, 20);
        waitFor(3);
        btnPause.click();
